...
// Colour codes in Tui
inline void set_foreground_rgb(int r, int g, int b) { printf("\033[38;2;%d;%d;%dm", r, g, b); }
...
void test_MixedElements() {
    ...
    std::string expected_html = "<h1>Title</h1>\n<p>This is a <strong>paragraph</strong> with <em>emphasis</em>.</p>\n<ul>\n<li>List Item 1</li>\n<li>List Item 2</li>\n</ul>\n";
    std::string actual_html = convert_markdown_to_html(markdown_input);
...
void test_EmptyInput() {
    ...
    std::string expected_html = ""; // Adjust based on your function's behavior for empty input
    std::string actual_html = convert_markdown_to_html(markdown_input);
...
void test_InlineLink() {
    ...
    std::string expected_html = "<p>Visit <a href=\"https://www.google.com\">Google</a>.</p>\n";
    std::string actual_html = convert_markdown_to_html(markdown_input);
    ASSERT_EQ(actual_html, expected_html, "Inline Link Test");
}

// Test case for reference-style link
void test_ReferenceLink() {
    std::string markdown_input = "This is a [reference link][mylink].\n\n[mylink]: http://example.org \"Example Title\"";
    // Expected HTML will vary slightly based on where your converter places the reference definition.
    // A typical approach removes the definition line from the body.
    std::string expected_html = "<p>This is a <a href=\"http://example.org\" title=\"Example Title\">reference link</a>.</p>\n";
    std::string actual_html = convert_markdown_to_html(markdown_input);
    ASSERT_EQ(actual_html, expected_html, "Reference Link Test");
}

// Test case for footnote definition and reference
void test_Footnote() {
    std::string markdown_input = "Here is some text with a footnote[^1].\n\n[^1]: This is the content of the footnote.";
    // The expected HTML for footnotes is quite specific and includes IDs and back-links.
    // This assumes a common output format. Adjust if your converter generates different HTML.
    std::string expected_html =
            "<p>Here is some text with a footnote<sup><a href=\"#fn:1\" id=\"fnref:1\">1</a></sup>.</p>\n"
            "<div class=\"footnotes\">\n"
            "  <hr>\n"
            "  <ol>\n"
            "    <li id=\"fn:1\">\n"
            "      This is the content of the footnote. <a href=\"#fnref:1\" title=\"Jump back to footnote 1 in the text\">↩</a>\n"
            "    </li>\n"
            "  </ol>\n"
            "</div>\n";
    std::string actual_html = convert_markdown_to_html(markdown_input);
...
void test_MultipleFootnotes() {
    std::string markdown_input = "First footnote[^a]. Second footnote[^b].\n\n[^a]: Content for footnote 'a'.\n[^b]: Content for footnote 'b'.";
    std::string expected_html =
            "<p>First footnote<sup><a href=\"#fn:a\" id=\"fnref:a\">a</a></sup>. Second footnote<sup><a href=\"#fn:b\" id=\"fnref:b\">b</a></sup>.</p>\n"
            "<div class=\"footnotes\">\n"
            "  <hr>\n"
            "  <ol>\n" // Or <ul> depending on how you list them
            "    <li id=\"fn:a\">\n"
            "      Content for footnote 'a'. <a href=\"#fnref:a\" title=\"Jump back to footnote a in the text\">↩</a>\n"
            "    </li>\n"
            "    <li id=\"fn:b\">\n"
            "      Content for footnote 'b'. <a href=\"#fnref:b\" title=\"Jump back to footnote b in the text\">↩</a>\n"
            "    </li>\n"
            "  </ol>\n"
            "</div>\n";
    std::string actual_html = convert_markdown_to_html(markdown_input);
...
void test_LinkAndFootnoteInteraction() {
    std::string markdown_input = "Check out [my website](http://example.com)[^note].\n\n[^note]: This is a note about the website.";
    std::string expected_html =
            "<p>Check out <a href=\"http://example.com\">my website</a><sup><a href=\"#fn:note\" id=\"fnref:note\">note</a></sup>.</p>\n"
            "<div class=\"footnotes\">\n"
            "  <hr>\n"
            "  <ol>\n"
            "    <li id=\"fn:note\">\n"
            "      This is a note about the website. <a href=\"#fnref:note\" title=\"Jump back to footnote note in the text\">↩</a>\n"
            "    </li>\n"
            "  </ol>\n"
            "</div>\n";
    std::string actual_html = convert_markdown_to_html(markdown_input);
...
void register_all_markdown_tests() {
    ...
    register_test("ReferenceLink", test_ReferenceLink);
